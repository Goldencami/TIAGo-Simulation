...
To be able to launch our simulation, you must copy the custome world from `launch_sim/worlds/sim_world1.world` and paste it inside `pal_gazebo_worlds/worlds`.
